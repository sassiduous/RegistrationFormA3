<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="WebFormAssignment1.WebForm1" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="Button1" runat="server" PostBackUrl="~/Registration.aspx" Text="Back" />
    </form>
</body>
</html>
